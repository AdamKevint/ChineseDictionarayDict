...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [label.text sizeWithAttributes:dict];
    ...
    NSDictionary *ddict = [NSDictionary dictionaryWithObjectsAndKeys:detailsLabel.font,NSFontAttributeName,nil];
	CGRect rect = [detailsLabel.text boundingRectWithSize:maxSize options: NSStringDrawingUsesFontLeading attributes:ddict context:nil];

    CGSize detailsLabelSize = rect.size;    //[detailsLabel.text sizeWithFont:detailsLabel.font constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
